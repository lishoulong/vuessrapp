...
(function(global,factory){
    ...
    CallApp.prototype.start=function(){
        ...
        if(deviceType.ios){
            ...
            // var regIos10=/OS [0-9]{2}_\d[_\d]* like Mac OS X/i;
            // if(regIos10.test(u) && is58App){
            //     window.location.href="https://zhuan.58.com/zz/redirect/download"
            // }else{
            //     startApp(scheme,loadUrl,15);
            // }
    ...
    function startApp(scheme,loadUrl,time){
        ...
        var hasApp=true;
        //var knowHasAppDelayTime=600,dealHasAppDelayTime=600;
        if(!noSupportIframe){
        ...
        setTimeout(function(){
            ...
            if(!hasApp){
                if(newBaseParam.middleWareUrl){
                    window.location.href = newBaseParam.middleWareUrl;
                    return ;
                }

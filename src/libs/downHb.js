...
(function(global,factory){
    ...
    var baseParam={
        ...
        urlSearch:{},
        appStore:'https://zhuan.58.com/zz/redirect/download',
        androidApk:'https://zhuan.58.com/zz/redirect/download',
        channelId:923
    };
    /**
     *判断是否是58APP内置h5。
     ...
     */
    function DownHb(){};
    DownHb.prototype.start=function(){
        var param=arguments[0];
        newBaseParam=mergeParam([baseParam,param]);
        var scheme=null,loadUrl=null;
        if(deviceType.ios){
            scheme=newBaseParam.iosScheme+'?'+serializeJson(newBaseParam.urlSearch)+'&time='+Date.now();
    ...
    function startApp(scheme,loadUrl,time){
        ...
        setTimeout(function(){
            ...
            if(!hasApp){
                window.location.href = "//m.zhuanzhuan.58.com/Mzhuanzhuan/Mhongbao/newyear_hb.html?zhuanzhuanSourceFrom=960&zzqdFrom=58APP_tohb&isAPP=true&client=58APP";
            }
        },dealHasAppDelayTime);
    };
    /**
    ...
    function append58AppRelyon(callback){
        ...
        oScript.setAttribute('src','//j2.58cdn.com.cn/m58/app58/m_static/js/app.js');
